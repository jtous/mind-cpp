...
public class CppDefinitionMacroSourceGenerator
    extends
      DefinitionIncSourceGenerator {

  /** The name to be used to inject the templateGroupName used by this class. */
  public static final String    TEMPLATE_NAME    = "cpp.definitions.implementations.macro";

  /** The default templateGroupName used by this class. */
  public static final String    DEFAULT_TEMPLATE = "st.cpp.definitions.implementations.Macro";
   ...
   */
  @Inject
  protected CppDefinitionMacroSourceGenerator(
